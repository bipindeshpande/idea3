"""
Recommendation Parser - Single source of truth for recommendation/idea parsing

Consolidates all recommendation parsing logic from recommendation_parser.py.

This parser handles:
1. Parsing recommendations from IDEA_X format (### IDEA_1, ### IDEA_2, etc.)
2. Extracting key:value pairs from idea blocks
3. Validating and filtering recommendations
4. Formatting recommendations for frontend display
"""
...
class RecommendationParser:
    ...
    All recommendation parsing operations should use this class to ensure consistency.
    """
    
    @staticmethod
    def parse_recommendations(text: str) -> List[Dict[str, Any]]:
        """
        Parse recommendations from text using the strict IDEA_X format.
        ...
        try:
            ...
            logger.warning("idea_validator not available, skipping validation filter")
            valid_recommendations = unique_recommendations
    ...
    def _parse_idea_block(content: str) -> Optional[Dict[str, Any]]:
        ...
        Args:
            content: Content of a single IDEA block
            
        Returns:
            Parsed idea dict, or None if invalid
        """
        result = {}
    ...
    def format_recommendations_for_frontend(recommendations: List[Dict[str, Any]]) -> str:
        ...
        Args:
            recommendations: List of parsed recommendation dictionaries
