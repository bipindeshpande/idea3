...
const nav = [
 { to: "/dashboard", label: "My Workspace", icon: "📊" },
 { to: "/validate-idea", label: "Validate Your Idea", icon: "✓" },
 { to: "/advisor", label: "Discover New Ideas", icon: "💡" },
 { to: "/dashboard/frameworks", label: "My Validation Frameworks", icon: "📋" },
 { to: "/founder-connect", label: "Founder Network", icon: "🤝" },
...
export default function Sidebar({ isCollapsed, onToggleCollapse }) {
 ...
 <div className={`mt-1 text-xs text-secondary ${isCollapsed ? "hidden" : ""}`}>Workspace</div>
 </div>
 ...
 className={({ isActive }) =>
 [
 "flex items-center gap-3 ui-radius-btn py-2.5 text-sm font-medium transition leading-tight",
