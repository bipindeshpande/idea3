...
export default function ReviewScreen({ inputs }) {
 ...
 <h3 className="text-lg font-semibold text-primary flex items-center gap-2">Review what you've shared</h3>
 <Card>
 <div className="grid gap-2">
 <SectionHeader title="About You" />
 <div className="grid gap-1 text-primary text-primary leading-relaxed">
