...
function OpenForCollaboratorsButton({ 
 ...
 onClick={handleClick}
 disabled={loading}
 className="rounded-xl border border-default bg-surface px-4 py-2 text-sm font-semibold text-accent shadow-sm transition hover:bg-surface-hover whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 className="flex-1 px-4 py-2 bg-accent text-on-accent rounded-lg hover:bg-accent-hover"
 >
 Create Profile
 </button>
 <button
 ...
 disabled={loading}
 className="flex-1 px-4 py-2 bg-accent text-on-accent rounded-lg hover:bg-accent-hover disabled:opacity-50"
 >
