  ...
  return (
    <div className="space-y-6">
      ...
      {validationQuestions && validationQuestions.length > 0 && (
        <div className="mt-0">
          <h3 className="text-lg font-semibold text-primary mb-2 border-l-4 border-default pl-3">Validation Questions</h3>
          <p className="text-sm text-primary mb-3">
      ...
      {!personaMarkdown && (!validationQuestions || validationQuestions.length === 0) && (
        <p className="text-sm text-primary italic">No customer persona information available yet.</p>
      )}
    </div>
  );
}
