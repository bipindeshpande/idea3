    ...
    <div className="mx-auto max-w-7xl px-6 py-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-2">Workspace</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Your explored ideas and thinking history.
            </p>
          </div>
          <Link
            to="/dashboard"
      ...
      {/* Main Workspace */}
      <section className="mb-8 rounded-2xl border-2 border-slate-300/80 dark:border-slate-600/80 bg-white dark:bg-slate-800 p-8 shadow-xl">
        {/* Workspace tabs */}
        <div className="mb-8 border-b-2 border-slate-300/60 dark:border-slate-600/60">
