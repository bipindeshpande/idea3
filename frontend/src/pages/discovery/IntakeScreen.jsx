...
const fieldClasses = "ui-field text-sm focus-visible:outline-accent";
...
export default function IntakeScreen({ inputs, onChange, errors = {} }) {
 ...
 <p className="text-xs text-accent">{errors.time_commitment}</p>
 )}
 </div>
 ...
 {errors.budget_range && (
 <p className="text-xs text-accent">{errors.budget_range}</p>
 )}
 </div>
 ...
 <p className="text-xs text-accent">{errors.risk_tolerance}</p>
 )}
 </div>
 </div>
 ...
 className={[
   "ui-button text-xs px-3 py-1.5 whitespace-nowrap",
 ...
 {errors.skills && (
 <p className="text-xs text-accent mt-1">{errors.skills}</p>
 )}
 </div>
 ...
 <p className="text-xs text-accent">{errors.preferred_work_style}</p>
 )}
 </div>
 ...
 <p className="text-xs text-accent">{errors.startup_style}</p>
 )}
 </div>
 </div>
 ...
 <p className="text-xs text-accent">{errors.customer_interaction}</p>
 )}
 </div>
 ...
 <p className="text-xs text-accent">{errors.location_context}</p>
 )}
 </div>
 </div>
 ...
 <p className="text-xs text-accent">{errors.business_region}</p>
 )}
 </div>
 ...
 <p className="text-xs text-accent">{errors.industry_interest}</p>
 )}
 </div>
 ...
 <p className="text-xs text-accent">{errors.sub_interest_area}</p>
 )}
 </div>
 )}
 ...
 <p className="text-xs text-accent">{errors.business_type}</p>
 )}
 </div>
 ...
 <p className="text-xs text-accent">{errors.earnings_timeline}</p>
 )}
 </div>
 </div>
 ...
 <p className="text-xs text-accent">{errors.founder_ambition}</p>
 )}
 </div>
 ...
 <p className="text-xs text-accent">{errors.experience_summary}</p>
 )}
 </div>
 ...
 className="w-full rounded-lg bg-accent hover:bg-accent-hover text-on-accent px-4 py-2 text-sm font-semibold transition-colors shadow-sm"
 >
