...
const fieldClasses = "ui-field focus-visible:outline-accent";
const textInputClasses = "ui-input focus-visible:outline-accent";
...
export default function FounderPsychology() {
 ...
 <div>
 <label className="block text-sm text-secondary mb-2">
 8. Which founder archetype best describes you? <span className="text-accent">*</span>
 </label>
 <select
