      ...
      <div className="min-h-screen py-12 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 flex justify-between items-center relative">
            ...
            <Link
              to="/psyche/questionnaire"
              className="px-5 py-2.5 rounded-lg font-medium text-indigo-700 bg-indigo-50 hover:bg-indigo-100 transition-all shadow-sm hover:shadow-md text-sm"
            >
              Retake Assessment
            </Link>
          </div>
          ...
          {/* Work Preferences */}
          <div className="mb-8 rounded-xl border border-gray-200 shadow-sm bg-white p-6 md:p-7">
