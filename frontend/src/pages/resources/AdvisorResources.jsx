    ...
    <PageContainer maxWidth="4xl">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <Card>
            <SectionHeader title="How recommendations are generated" className="text-lg mb-2" />
          ...
          <Card>
            <SectionHeader title="What inputs matter most" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed">
          ...
          <Card>
            <SectionHeader title="Why some ideas are filtered out" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <Card>
            <SectionHeader title="Risk vs reward framing" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed">
          ...
          <Card>
            <SectionHeader title="Time-to-revenue logic" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed">
          ...
          <Card>
            <SectionHeader title="Skill leverage model" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed">
          ...
          <Card>
            <SectionHeader title="Validation-before-build mindset" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          <Card>
            <SectionHeader title="How to read a Discovery result" className="text-lg mb-2" />
          ...
          <Card>
            <SectionHeader title="What to do if you disagree with a recommendation" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed">
          ...
          <Card>
            <SectionHeader title="When to rerun vs when to validate" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed mb-3">
              <strong className="text-gray-900">Rerun discovery</strong> when your constraints change 
              (more/less time, different budget, new skills) or you want to explore different industries or business models.
            </p>
            <p className="text-[15px] text-gray-700 leading-relaxed">
              <strong className="text-gray-900">Run validation</strong> when you have a specific idea 
      ...
      <div className="mb-8">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <SectionHeader title="Validation Checklist" className="text-lg mb-2" />
          ...
          <Card>
            <SectionHeader title="Customer Interview Script" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed mb-4">
          ...
          <Card>
            <SectionHeader title="MVP Scoping Guide" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed mb-4">
          ...
          <Card>
            <SectionHeader title="Experiment Templates" className="text-lg mb-2" />
            <p className="text-[15px] text-gray-700 leading-relaxed mb-4">
